...
namespace OrnekProje
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.IdleTimeout = TimeSpan.FromMinutes(30); //yarým saat sonra oturumu kapatýr
            ...
            });  //   Facebook ile ilgili olan baðlantý kýsmý
            ...
            }); //   Google ile ilgili olan baðlantý kýsmý
